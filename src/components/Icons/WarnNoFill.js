...
const Warn = (props) => {
  ...
  return (
    <IconContainer {...props}>
      <svg viewBox="0 0 492.426 492.426" width={width} height={height} preserveAspectRatio="xMidYMin">
        ...
        <path d="M264.013 330.213h-35.6l-5-164.6h45.6zM228.513 350.113h35.4v35.4h-35.4z" />
      </svg>
    </IconContainer>
  );
};
